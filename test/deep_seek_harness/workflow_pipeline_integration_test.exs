defmodule DeepSeekHarness.WorkflowPipelineIntegrationTest do
  use ExUnit.Case, async: true

  alias DeepSeekHarness.WorkflowIndex

  setup do
    tmp_dir = Path.join(System.tmp_dir!(), "dsh_wf_integration_test_#{:rand.uniform(100_000)}")
  ...
  test "closes out active item to completed/ and records close-out lesson", %{
    ...
    {:ok, lessons_content, _} = DeepSeekHarness.Lessons.load_lessons(tmp_dir)
