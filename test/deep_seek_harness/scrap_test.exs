defmodule DeepSeekHarness.ScrapTest do
  use ExUnit.Case, async: true

  alias DeepSeekHarness.Scrap

  setup do
    tmp_dir = Path.join(System.tmp_dir!(), "dsh_scrap_test_#{:rand.uniform(100_000)}")
  ...
  test "appends and reads scrap notes", %{tmp_dir: tmp_dir} do
    ...
    assert String.ends_with?(path, ".dsh/scrap.md")
