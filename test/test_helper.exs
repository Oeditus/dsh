test_history_path =
  Path.join(System.tmp_dir!(), "yoke_test_history_#{System.unique_integer([:positive])}")

Application.put_env(:yoke, :history_file, test_history_path)
Application.put_env(:yoke, :auto_start_ragex, false)
