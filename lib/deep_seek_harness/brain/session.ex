defmodule DeepSeekHarness.Brain.Session do
  ...
  - ALWAYS use Ragex image tools (`image_info`, `image_resize`, `image_crop`, `image_rotate`, `image_convert`, `image_apply_filter`, `image_composite`, `image_avatar`, `image_draw_text`, `image_compare`, `mcp_ragex_image_*`) whenever you need to inspect, resize, crop, convert, filter, composite, or compare images, instead of writing custom scripts or executing raw shell commands.
