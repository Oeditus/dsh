defmodule DeepSeekHarness.WorkflowIndex do
  @moduledoc """
  ...
  @doc """
  Ensures stage directory scaffolding exists under `cwd/project/workflow/` or `cwd/.dsh/workflow/`.
  """
