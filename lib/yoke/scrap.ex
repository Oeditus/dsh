defmodule Yoke.Scrap do
  @moduledoc """
  Manages transient scratch notes (`project/scrap.md` or `.yoke/scrap.md`).
  ...
  otherwise defaults to `.yoke/scrap.md`.
  """
  def scrap_file_path(cwd \\ ".") do
    project_scrap = Path.join(cwd, "project/scrap.md")
    yoke_scrap = Path.join(cwd, ".yoke/scrap.md")
