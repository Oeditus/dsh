defmodule Yoke.Lessons do
  @moduledoc """
  Manages operational lessons learned (`project/lessons.md` or `.yoke/lessons.md`).
  ...
  otherwise defaults to `.yoke/lessons.md`.
  """
  def lessons_file_path(cwd \\ ".") do
    project_lessons = Path.join(cwd, "project/lessons.md")
    yoke_lessons = Path.join(cwd, ".yoke/lessons.md")
