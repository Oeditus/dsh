defmodule Yoke.Workflow.Plan do
  @moduledoc """
  ...
  `Yoke.Client.DeepSeekAPI.chat_completion/3` directly with a plain
  ...
  @system_prompt """
  You are assisting Yoke's plan gate on a single, focused, tool-free \
